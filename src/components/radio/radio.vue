...
export default {
  ...
  props: {
    ...
    tipName: {
      type: String,
      default: () => config.getOption('dict', 'tipName')
    }
  },
  data() {
    return {
